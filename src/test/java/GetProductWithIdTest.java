...
public class GetProductWithIdTest extends BaseTest {
    ...
    void getProductIdTest(){
        ...
        assertThat(Objects.requireNonNull(response.body()).getId(), equalTo(NumericField.ID_PRODUCT.getIntMeaning()));
        assertThat(response.body().getTitle(), equalTo("Asteria"));
        assertThat(response.body().getPrice(), equalTo(1000000000));
        assertThat(response.body().getCategoryTitle(),equalTo(Category.FURNITURE.getTitle()));
    }
